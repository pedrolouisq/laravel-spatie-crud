...
class PermissionController extends Controller
{
    ...
    {
        // Don't delete basic permissions to prevent lockouts
        $protectedPermissions = ['manage roles', 'manage permissions', 'manage users', 'view tasks', 'create tasks', 'edit tasks', 'delete tasks'];
        if (in_array($permission->name, $protectedPermissions)) {
            return redirect()->route('permissions.index')->with('error', 'Este permiso del sistema no se puede eliminar.');
        }
